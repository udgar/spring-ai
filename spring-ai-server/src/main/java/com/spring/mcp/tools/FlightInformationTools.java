...
public class FlightInformationTools {
    ...
    public String addFlight(
            @ToolParam(description = "The flight id, eg. 3456")String flightId,
            @ToolParam(description = "The airline id, eg. BUD")String airlineId,
            @ToolParam(description = "The flight number, eg. RA217")String flightNumber,
            @ToolParam(description = "Start point, eg. KTM")String startPoint,
            @ToolParam(description = "End point, eg. DEL")String endPoint,
            @ToolParam(description = "Status, eg. Scheduled, Cancelled")String status,
            @ToolParam(description = "Duration, eg. 120 ")String duration
    ){
        try {
